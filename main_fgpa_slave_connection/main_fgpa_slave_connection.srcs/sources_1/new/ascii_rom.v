...
module ascii_rom(
	...
	always @*
		case(addr)
			...
			11'h2f3: data = 8'b00000011;	//
			11'h2f4: data = 8'b00000110;	//
			11'h2f5: data = 8'b00001100;	//
			11'h2f6: data = 8'b00011000;	//
			11'h2f7: data = 8'b00110000;	//
			...
			11'h402: data = 8'b11111111;	//
			11'h403: data = 8'b10000001;	//
			11'h404: data = 8'b10000001;	//
			11'h405: data = 8'b10000001;	//
			11'h406: data = 8'b10000001;	//
			11'h407: data = 8'b10000001;	//
			11'h408: data = 8'b10000001;	//
			11'h409: data = 8'b10000001;	//
			11'h40a: data = 8'b10000001;	//
			11'h40b: data = 8'b11111111;	//********
